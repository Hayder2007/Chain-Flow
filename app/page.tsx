        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8 mb-8">
            ...
            <div className="lg:max-w-md">
              ...
              <p className="text-gray-400 mb-4">Get the latest updates on ChainFlow development</p>
              <form className="flex flex-col sm:flex-row gap-3" onSubmit={handleNewsletterSubmit}>
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[#00FFE5] text-black font-semibold rounded-lg hover:bg-[#00FFE5]/90 transition-colors whitespace-nowrap disabled:opacity-50"
                >
